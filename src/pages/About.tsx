  ...
  return (
    <section className="article">
      ...
      <p>
        ...
        <code>body</code> 或 <code>sections[]</code>），再把条目登记进 <code>data/catalog.json</code>。字段约定见{" "}
        <code>data/schema/collection.schema.json</code> 与根目录 <code>AGENTS.md</code>。
      </p>
      <p>
        <code>status: published</code> 才能从首页进详情；<code>planned</code> / <code>draft</code> 只出现在对应
        section。跨项目已验证方案由 Skill <code>kg-ingest</code> 按同一规范回填。
      </p>
